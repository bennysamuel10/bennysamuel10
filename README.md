...
I am an Electrical & Electronics Engineering graduate currently pursuing an **M.Tech in Artificial Intelligence at SRM University**.  
I am passionate about combining **AI, data analytics, and business strategy** to build impactful digital products.

I have experience in **business analysis, market research, and product insights**, with internships in fintech and market analytics.

My goal is to become a **Product Analyst / Product Expert in Fintech**, building AI-driven solutions that create real business impact.

---

## 🚀 About Me

- 🎓 B.E Electrical & Electronics Engineering – LICET
- 🎓 M.Tech Artificial Intelligence – SRM University
- 📊 Business Analyst Intern – Mylapay Fintech
- 📈 Former Market Analyst Intern – Maxitome Management Services
- 🤖 Currently learning Generative AI and Advanced Data Analytics
- 🎤 Strong in Public Speaking, Strategy, and Client Interaction
...
Developed an AI system to classify biodegradable, recyclable, wet, and dry waste using image processing and automated bin mechanisms.

### Pedestrian Detection & ABS Triggering System (Volvo Project)
Built a safety system for forklifts that detects pedestrians and automatically triggers braking.

### Electrical Symbol Classification using AI
Created a machine learning model using OpenCV to recognize electrical symbols in circuit diagrams.
...
📧 Email  
bennysamuel2102@gmail.com

🔗 LinkedIn  
https://www.linkedin.com/in/benny-samuel
